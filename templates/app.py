...
def apply():
    ...
    try:
        ...
        """
        cursor.execute(query, (first_name, last_name, contact_number, email, experience, location_str, position_str, resume_path))
        conn.commit()
        ...
        try:
            ...
            if smtp_settings.get('smtp_user') and smtp_settings.get('smtp_password'):
                ...
                msg['Reply-To'] = 'confidosoftsolutionpvtltd@gmail.com'
                ...
                <body>
                    <div class="container">
                        ...
                        <div class="content">
                            ...
                            <div class="field"><span class="label">Phone:</span> {contact_number}</div>
        ...
        response_msg = "Application Saved to DB."
        if email_status == "sent":
            response_msg += " Notification email sent successfully."
        else:
            response_msg += f" WARNING: Email failed. Logs: {' | '.join(email_debug_log)}"
